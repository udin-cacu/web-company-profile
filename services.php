          ...
          <div class="row">
            ...
            <div class="col m4 s12">
              <div class="card-panel center">
                <a href="cleaner.php" class="btn-floating btn-large pulse"><i class="material-icons medium">laptop</i></a>
                <h5>CLEANING SERVICE</h5>
                <p>PT Wastu Mandala Merupakan salah satu penyedia Jasa Cleaning Service dengan pelayanan optimal yang berorientasi pada kepuasan pelanggan(Mitra, Relasi, & Klien).</p>
              </div>
            </div>
            <div class="col m4 s12">
            </div>
