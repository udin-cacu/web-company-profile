...
$email_pengirim = 'example@mail.com'; // Isikan dengan email pengirim
$nama_pengirim = 'nama_pengirm'; // Isikan dengan nama pengirim
...
$mail->Password = 'sisikanpass'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
...
$mail->Subject = $subjek;
$mail->Body = $content;
$mail->AddEmbeddedImage('', 'cid:logo_mynotescode', ''); // Aktifkan jika ingin menampilkan gambar dalam email

if(empty($attachment)){ // Jika tanpa attachment
    $send = $mail->send();

    if($send){ // Jika Email berhasil dikirim
        echo "<h1>Email berhasil dikirim</h1><br /><a href='contact.php'>Kembali ke Form</a>";
    }else{ // Jika Email gagal dikirim
        echo "<h1>Email gagal dikirim</h1><br /><a href='contact.php'>Kembali ke Form</a>";
    ...
    if($size <= 25000000){ // Jika ukuran file <= 25 MB (25.000.000 bytes)
        ...
        echo "<h1>Ukuran file attachment maksimal 25 MB</h1><br /><a href='contact.php'>Kembali ke Form</a>";
    }
}
?>
